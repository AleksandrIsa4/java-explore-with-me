...
public class EventPrivateController {
    ...
    public EventRequestStatusUpdateResult patchEventRequestsPriv(@PathVariable Long userId, @PathVariable Long eventId, @RequestBody(required = false) EventRequestStatusUpdateRequest dto) {
